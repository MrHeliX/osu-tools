...
namespace PerformanceCalculator.Simulate
{
    public abstract class SimulateCommand : ProcessorCommand
    {
        ...
        public override void Execute()
        {
            ...
            var statistics = GenerateHitResults(Accuracy / 100, beatmap, Misses, Mehs, Goods, Oks, Greats);
            var score = Score;
        ...
        protected abstract Dictionary<HitResult, int> GenerateHitResults(double accuracy, IBeatmap beatmap, int countMiss, int? countMeh, int? countGood, int? countOk, int? countGreat);
